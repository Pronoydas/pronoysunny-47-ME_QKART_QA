...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            // box
            WebElement searchBox = driver.findElement(By.xpath("(//input[@name='search' and @placeholder='Search for items/categories'])[1]"));
            searchBox.clear();
            searchBox.sendKeys(product);
            Thread.sleep(1000);
            WebDriverWait wait = new WebDriverWait(driver,15);
            wait.until(ExpectedConditions.or(ExpectedConditions.presenceOfElementLocated(By.className("css-s18byi")),
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver.findElementByXPath("//h4[normalize-space()='No products found']").isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
