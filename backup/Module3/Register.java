...
public class Register {
    ...
    public Boolean registerUser(String Username, String Password, Boolean makeUsernameDynamic)
        ...
        WebElement register_now_button = this.driver.findElement(By.xpath("//*[@id='root']/div/div/div[2]/div/button"));

        // Click the register now button
        register_now_button.click();
       
        WebDriverWait wdw = new WebDriverWait(driver, 30);
        wdw.until(ExpectedConditions.or(ExpectedConditions.urlContains("/login"),
        ExpectedConditions.presenceOfElementLocated(By.className("css-8atqhb"))));
       
        this.lastGeneratedUsername = test_data_username;

        boolean istrue= this.driver.getCurrentUrl().endsWith("/login");
        return istrue;
