...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            WebElement parentBox = driver.findElement(By.xpath("//h4[text()='Shipping']//..//*[@class='MuiBox-root css-0']"));
            List<WebElement> allBoxes = parentBox.findElements(By.tagName("div"));
