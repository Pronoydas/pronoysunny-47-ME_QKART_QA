...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver, 30);
            wait.until(ExpectedConditions.or(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(String
            .format("//div[@class='MuiCardContent-root css-1qw96cp'][1]/p[contains(text(),'%s')]", product))),
            ExpectedConditions.textToBe(By.xpath("//h4[normalize-space()='No products found']"), " No products found ")));
            Thread.sleep(1000);
            return true;
        } catch (Exception e) {
